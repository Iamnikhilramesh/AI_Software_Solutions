...
def home():
    ...
    st.text("The passionate team who are ready to take up any challenging task and complete it on time, AI should be a benefit for our society and everyone in the society.")
